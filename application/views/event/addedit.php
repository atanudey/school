      ...
      <div class="form-group">
          ...
          <div class="col-md-8">              
              <div class="input-append date event_date">
                <input type="text" style="width:150px" name="Date" value="<?php echo ($this->input->post('Date') ? $this->input->post('Date') : $event['Date']); ?>" class="form-control" id="Date"  class="datetimepicker-input" required="required" />
