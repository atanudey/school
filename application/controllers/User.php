...
class User extends MY_Controller {
    ...
    function profile() {
        ...
        if ($this->form_validation->run() === true) {
            ...
            if ($result) {
                ...
                $this->session->set_flashdata('flashError', 'There was a problem updating your profile. Please try again.');
            }
    ...
    function read_email() {
        ...
        $hostname = '{imap.gmail.com:993/novalidate-cert/imap/ssl}INBOX';
        //$username = 'mratanudey83@gmail.com';
        $username = 'newsworm.india@gmail.com';
        //$password = 'Dey1983atanu@$';
        $password = 'NewsW0rm@India';
