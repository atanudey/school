CREATE DEFINER=`mydevloper`@`localhost` PROCEDURE `sp_CorrectionAttendance`(IN `schoolid` VARCHAR(7), IN `candidateid` INT(10), IN `inORout` VARCHAR(3), IN `correctionDate` DATE, OUT `successmessage` VARCHAR(100))
    NO SQL
root:BEGIN
